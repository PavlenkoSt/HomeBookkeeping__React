...
const ModalBillContainer = ({ bill, changeBill, historyTransactions, changeModalMode }) => {
    ...
    return <ModalBill onSubmit={onSubmit} defaultHeaderText={defaultHeaderText} cancelModalMode={cancelModalMode} bill={bill} />
}
